...
$guest_id_from_session = $_SESSION['guest_id'];
...
if ($pdo) { 
    try {
        ...
        if ($guest_data_from_db) {
            ...
            $_SESSION['has_rsvpd'] = $db_has_rsvpd;
        } else {
...
$rsvp_success_message = $_SESSION['rsvp_success_message'] ?? null;
unset($_SESSION['rsvp_success_message']);
$rsvp_error_message = $_SESSION['rsvp_error_message'] ?? null;
