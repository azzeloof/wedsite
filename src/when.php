...
<body class="d-flex h-100 text-bg-light">
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-8">
                <div class="row my-3">
                    <h1>Saturday October 11<sup>th</sup>, 2025</h1>
                    <p>Please aim to arrive at 2:30 for a prompt ceremony start time!</p>
                    <h3>3:00 pm - Ceremony</h3>
                    <p>Outdoors by the pond</p>
                    <h3>3:30 pm - Cocktail Hour</h3>
