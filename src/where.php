    ...
    <div class="d-flex w-100 h-100 py-3 px-4 mx-auto flex-column">
        ...
        <div class="container my-5">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row my-3">
                        <p>The exact address will be printed on your invitation, and is available in the <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" role="button">Guest Portal</a>.</p>
                        <h2>Travel</h2>
                        <p>The closest major airports are Philadelphia (PHL) and Newark (EWR) (Sergeantsville is about an hour drive from each). For international travelers, JFK is also a good option. There's also a tiny airport in Ewing (TTN- 25 minutes from the farm). If you're flying American, you can actually book a flight through there (which five minutes from to the first hotel listed below). They operate three shuttle busses from TTN to PHL each day, and for the return trip you can even go through security and check bags at TTN. More info <a href="https://www.aa.com/i18n/travel-info/experience/landline.jsp" target="blank">here</a>. Frontier also operates out of there.</p>
                        <p>The closest Amtrak station is in Trenton, about a half hour away. From New York and Newark, you can grab an NJ Transit train to Raritan Station, which is also about a half hour drive away. There will be plenty of parking available.</p>
                        <h2>Lodging</h2>
                        ...
                        <h6><i>Room block available here</i></h6>
                        <p>A large chain hotel right next to Trenton-Mercer Airport. Relativley cheap, but not a walkable area. Transportation to/from the wedding will be provided (but only at the start/end). The room block discount code will be available in the online Guest Portal once invitations go out in July, but reach out to Adam and Sara if you need to book sooner.</p>
