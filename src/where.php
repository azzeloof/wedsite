    ...
    <div class="d-flex w-100 h-100 py-3 px-4 mx-auto flex-column">
        ...
        <div class="container my-5">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row my-3">
                        <p>The exact address will be printed on your invitation, and is available in the <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" role="button">Guest Portal</a>. We sent out invites at the end of July. If have a save the date and your invitation hasn't arrived please reach out to Adam or Sara to get your RSVP code!</p>
                        <h2>Travel</h2>
